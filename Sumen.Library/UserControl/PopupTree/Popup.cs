...
namespace PhoHa7.Library.UserControl.PopupTree
{
    ...
    public partial class Popup : ToolStripDropDown
    {
        ...
        public void Show(Control control, int caretPosition)
        {
            if (control == null)
            {
                throw new ArgumentNullException("control");
            }
            Show(control, control.ClientRectangle, caretPosition);
        }
        ...
        /// </remarks>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="control"/> is <code>null</code>.</exception>
        public void Show(Control control, Rectangle area, int caretPosition)
        {
            if (control == null)
            {
                throw new ArgumentNullException("control");
            ...
            location.X = location.X + caretPosition;
