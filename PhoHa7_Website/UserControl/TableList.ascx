<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TableList.ascx.cs" Inherits="UserControl_TableList" %>
                ...
                <div id="Div1" class="col-sm-3 col-xs-6 col-centered" style="border-right: 1px solid #ddd; border-bottom: 1px solid #dddd;">
                    <div class="row" style="margin-top: 5%; background: #FFF; margin-right: 10px; margin-left: 10px;">
                        <div class="  col-sm-12 col-xs-5 col-lg-4 col-lg-offset-3  col-xs-offset-3">
                            <div class="col-xs-12">
                                <%--2700ff--%>
                                <p style='background: <%#Convert.ToBoolean(Eval("TakeOut"))==true?"#2700ff":"#f39c11" %>; padding: 5px 0px 5px 0px; <%--margin: 0px 0px 0px 0px;--%> color: #FFF; text-align: center;' id="table_name">
