<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="UsersManagement.aspx.cs" Inherits="UsersManagement" %>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPanelUsersManager" Width="100%" Height="100%" runat="server" Theme="Metropolis" HeaderText="Users Management">
        <PanelCollection>
            <dx:PanelContent>
                ...
                <dx:ASPxGridView ID="gridUsersManagement" ClientInstanceName="gridUsersManagement" runat="server"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="SecurityCode" VisibleIndex="2" Visible="true" Caption="Passcode">
