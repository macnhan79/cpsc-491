<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SquarePaymentCallBack.aspx.cs" Inherits="SquarePaymentCallBack" %>
...
<body onload="printResponse()">
    ...
    <form id="form1" runat="server">
        ...
        <h1>Something Wrong! Please remake the Payment. Thank you</h1>
        <h1><a href="Table.aspx">Go Back</a></h1>
